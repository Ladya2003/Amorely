...
export const GAMES: GameCatalogEntry[] = [
  {
    ...
    name: 'Тыкалка',
    description:
      'Нажимайте на блок вместе с партнёром: чередуйтесь, проходите раунды и зарабатывайте баллы на улучшения в магазине.',
    ...
    rules: [
      ...
      'Каждый проходит свою часть раунда по очереди — партнёр может быть офлайн.',
  ...
  },
  {
    ...
    rules: [
      ...
      'Выберите любую ячейку: категория и стоимость. На ответ — 30 секунд.',
