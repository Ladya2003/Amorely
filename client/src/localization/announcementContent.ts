...
export const PET_FEEDING_ANNOUNCEMENT_PRESET: {
  ...
  pushBody: {
    ...
    by: 'Новае: карміце гадаванцаў і зарабляйце Аморкі!',
  },
  translations: {
    ru: {
...
Загляньте до улюбленця на головній!`,
    ...
    by: {
      title: 'Кармленне гадаванцаў',
      preview:
        'Новая шкала сытасці, кнопка «Пакарміць» і ўзнагарода +5 Аморак за поўную сытасць.',
      content: `У кожнага гадаванца цяпер ёсць сытасць. Сачыце за ёй, карміце ўчасна — і атрымлівайце бонусы!

• Корм — 2 Аморкі, +10–20 сытасці
• Сытасць падае на 2/гадз
• Поўная сытасць (100) — +5 Аморак
• На картцы відаць настрой: 😾 / 😐 / 😊

Зазірніце да гадаванца на галоўнай!`,
    },
  },
};
...
export const DAILY_QUESTIONS_ANNOUNCEMENT_PRESET: {
  ...
  pushBody: {
    ...
    by: 'Новае: «Пытанні дня» — адказвайце разам і параўноўвайце адказы!',
  },
  translations: {
    ru: {
      title: 'Вопросы дня',
...
Загляньте на головну та почніть першу категорію разом!`,
    ...
    by: {
      title: 'Пытанні дня',
      preview:
        'Дзве катэгорыі на галоўнай: адказвайце паасобку і глядзіце вынікі разам.',
      content: `На галоўнай з’явіўся блок «Пытанні дня» — міні-гульня для пары!

• Кожны дзень — 2 катэгорыі (напрыклад, «Побут», «Першае спатканне»)
• Тыпы: тэкст, выбар варыянта, фота
• Спачатку адказваеце вы, потым партнёр — адказы схаваныя да канца
• Напрыканцы — % падабенства і параўнанне адказаў
• Гісторыя мінулых раундаў — іконка 🕐 у блоку
• Новыя катэгорыі праз 24 гадз пасля праходжання абодвума

Зазірніце на галоўную і пачніце першую катэгорыю разам!`,
    },
  },
};
