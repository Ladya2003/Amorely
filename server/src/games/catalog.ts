...
export const isGameVisibleToRole = (
  game: GameCatalogEntry | undefined,
  role?: string
): game is GameCatalogEntry => Boolean(game && (!game.adminOnly || role === 'admin'));
...
export const GAME_CATALOG: GameCatalogEntry[] = [
  {
    ...
    name: 'Скала Любви',
    description:
      'Доберитесь вместе до вершины: купите инструменты, добудьте руду, откройте врата, восстановите мост и переправьтесь по канатам.',
    imageUrl: '/games/cliff/catalog.png',
    ...
    rules: [
      ...
      'Инвентарь общий, кроме личных AmoreCoins.',
      'Каждый партнёр может купить только один вид кирки — железо или медь.',
      'В шахте десять валунов: пять с железом и пять с медью. Без нужной кирки валун не открыть.',
      'Топор стоит 20 железа и 20 меди — им открывают врата на Скалу Любви.',
      'После врат — мини-игра с мостом: каждому даётся 20 камешков, нужно попасть в три отверстия.',
      'После моста на нажимную плиту должны встать два питомца 2 уровня или выше — два одного партнёра или по одному от каждого.',
      'После подъёма плиты нужно переправиться по канатам: три до чекпоинта, затем ещё пять. Прыжок засчитывается, когда метка в зоне.',
      'Слова поощрения на секунду расширяют отверстие партнёра.',
      'Рейтинг строится по лучшему времени прохождения. Незавершённые забеги тоже видны в таблице.',
    ],
  },
  {
    id: 'geo',
