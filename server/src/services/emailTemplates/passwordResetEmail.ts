...
export const buildPasswordResetEmailSubject = (): string => 'Reset your Amorely password';

export const buildPasswordResetEmailText = (resetUrl: string): string =>
  [
    'Reset your Amorely password',
    '',
    'We received a request to reset the password for your Amorely account.',
 ...
 */
export const buildPasswordResetEmailHtml = (resetUrl: string): string => {
...
<head>
  ...
  <title>Reset your Amorely password</title>
</head>
          ...
          <tr>
            <td style="background-color:${CARD};border:1px solid rgba(255,75,141,0.28);border-radius:24px;padding:36px 28px;box-shadow:0 18px 48px rgba(0,0,0,0.35);">
              ...
              <p style="margin:0 0 28px;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif;font-size:15px;line-height:1.55;color:${MUTED};text-align:center;">
                Choose a new password for your private space for two.
              </p>
