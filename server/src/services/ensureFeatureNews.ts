...
Загляньте на головну та дізнайтеся одне про одного ще більше!`,
      ...
      by: {
        title: 'Пытанні дня ўжо на галоўнай!',
        content: `На галоўнай з’явіўся блок «Пытанні дня» — кароткія катэгорыі, якія вы праходзіце разам з партнёрам.

• Адказвайце па чарзе і параўноўвайце адказы
• Глядзіце падабенства адказаў у выніках
• За завершаную катэгорыю — +10 Аморак (да 2 катэгорый у дзень)
• Новыя катэгорыі абнаўляюцца кожны дзень

Зазірніце на галоўную і даведайцеся адно пра аднаго яшчэ больш!`,
      },
    },
  },
  {
...
Відкрийте блок «Улюбленці» на головній і заведіть першого друга!`,
      ...
      by: {
        title: 'Гадаванцы ў Amorely!',
        content: `Цяпер у вас можа быць свой гадаванец на галоўнай — абірайце від, колер і імя, расціце яго і даглядайце разам з партнёрам.

• Купля гадаванца — 100 Аморак
• Пракачка ўзроўняў за Аморкі і анімацыя «вылуплення»
• Кармленне: 2 Аморкі, +10–20 сытасці; поўная сытасць — +5 Аморак
• Можна зазірнуць да гадаванцаў партнёра і дапамагчы з пракачкай
• Падарыце гадаванца партнёру — прыемны сюрпрыз

Адкрыйце блок «Гадаванцы» на галоўнай і завядзіце першага сябра!`,
      },
    },
  },
  {
...
Відкрийте ідеї на головній і заплануйте наступний теплий вечір!`,
      ...
      by: {
        title: 'Ідэі для спатканняў!',
        content: `На галоўнай з’явіўся раздзел «Ідэі для спатканняў» — натхненне для асаблівых момантаў удваіх.

• Згенеруйце ідэю за 100 Аморак
• Выканайце або прапусціце — гісторыя захаваецца
• Дадайце спатканне ў каляндар пары
• За падзею з ідэі — +25 Аморак
• Даступна пасля прывязкі партнёра

Адкрыйце ідэі на галоўнай і заплануйце наступны цёплы вечар!`,
      },
    },
  },
];
