...
Чат
добавить иконку прочитал (собеседник) и отправлено (для пользователя), чтобы отличить кто последним отправил сообщение
если больше 100 новых сообщений, показывать 99+
