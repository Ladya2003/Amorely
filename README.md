...
---
1. далее нужно сделать работу планов как notes с маркдауном скорее всего tinymce
2. добавить достижение: 100 событий
...
промпт для показа в ленте:
отлично, я хочу динамично показывать контент в ленте. вот моя идея, 
